...
const ZONAS = {
  ...
  activar: { estado:'Borrador sin publicar', rot:'Prueba y publicación', titulo:'Construir no es producir', texto:'Durante el taller ejecutamos a mano. Publicar deja al disparador escuchando y congela la versión que va a correr: recién ahí el flujo opera sin intervención.', lista:['Probá más de un caso','Soltá los datos fijados','Publicá solo cuando haya responsable'], nodo:'trigger' }
};
