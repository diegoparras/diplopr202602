...
const CLASES = [
  ...
  { n:  5, fecha: '2026-09-02', dia: 'Miércoles', mod: 'M2', pagina: '05.html',
    titulo: 'Los ocho nodos que resuelven el noventa por ciento',
    bajada: 'Trigger, HTTP Request, IF, Switch, Merge, Edit Fields, Code y nodos de app, contra un sitio que no tiene API: un bot que consulta InfoLeg.' },
  { n:  6, fecha: '2026-09-09', dia: 'Miércoles', mod: 'M2', pagina: '06.html',
    titulo: 'Ramas, bucles, errores y el costo de cada ejecución',
    bajada: 'Qué cuenta como ejecución, las cuatro formas de fallar y la única que avisa, cuándo conviene reintentar y cómo se entera una persona.' },
  { n:  7, fecha: '2026-09-16', dia: 'Miércoles', mod: 'M3', pagina: '07.html',
    titulo: 'Del proceso manual al workflow: primer caso completo',
    bajada: 'El método de los cinco casilleros, un caso contado en desorden y un taller que convierte tu proceso en algoritmo y en esqueleto de n8n.' },
